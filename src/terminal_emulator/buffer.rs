...
pub(crate) struct TerminalBufferInsertResponse {
    pub(crate) written_range: Range<usize>,
...
impl crate::terminal_emulator::TerminalBuffer {
    pub(crate) fn new(width: usize, height: usize) -> crate::terminal_emulator::TerminalBuffer {
        crate::terminal_emulator::TerminalBuffer {
            buf: vec![],
            width,
            height,
        }
    ...
    pub(crate) fn clear_forwards(&mut self, cursor_pos: &CursorPos) -> Option<usize> {
    ...
    pub(crate) fn append_newline_at_line_end(&mut self, pos: &CursorPos) {
